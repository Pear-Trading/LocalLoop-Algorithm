...
sub initAfterStaticRestrictions {
  ...
  my $statementSelect = $self->dbh->prepare("SELECT ProcessedTransactions.TransactionId FROM ProcessedTransactions ORDER BY ProcessedTransactions.TransactionId ASC");
